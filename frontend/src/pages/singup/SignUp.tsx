...
import { InputContainer, StyledInput } from "./../../components/inputs/StyledInputs";
...
export const SignUp = () => {
  ...
  const codeChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    console.log("왜 출력이 안되지??");
    console.log(e);
  };

  // 회원가입 로직
  const handleSignUp: SubmitHandler<IForm> = (data) => {
    const { email, password, nickname, age, sex, height, weight, activity } = data;
    // axios
  ...
  const handleSendEmail = () => {
    ...
    if (errors.email) {
      ...
      axios
        .post(`${process.env.REACT_APP_BASE_URL}/member/sendVerification`, JSON.stringify(data), {
  ...
  const handleCheckEmail = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_BASE_URL}/member/checkVerification`, JSON.stringify(data), {
        headers: { "Content-Type": `application/json` },
      })
      .then((res) => {
        console.log(res);
  ...
  return (
    <div className={classes.container}>
      ...
      <br />
      <br />
      <p style={{ color: "#525252", fontSize: "1.5rem", fontWeight: "bold" }}>회원가입</p>
      <br />
        ...
        {progress === 0 && (
          <div className={classes.containerNoHeight}>
            ...
            <div className={classes.labelContainer}>
              ...
              {agree1 ? (
                <BsFillCheckSquareFill style={{ color: "#FE9D3A" }} onClick={() => setAgree1(0)} />
              ) : (
                <BsSquare
                  onClick={() => {
                    setAgree1(1);
            ...
            <div className={classes.labelContainer}>
              ...
              {agree2 ? (
                <BsFillCheckSquareFill style={{ color: "#FE9D3A" }} onClick={() => setAgree2(0)} />
              ) : (
                <BsSquare
                  onClick={() => {
                    setAgree2(1);
        ...
        {progress === 1 && (
          <div className={classes.containerNoHeight}>
            ...
            <div className={classes.InputContainer}>
              ...
              {checkEmail ? (
                <InputContainer>
                  <StyledInput placeholder="인증번호를 입력하세요" onChange={codeChange} />
                  <StyledButtonProps
                    width="4rem"
                    height="1srem"
                    fontSize="0.62rem"

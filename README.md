...
> 빅데이터 처리를 주먹구구식이 맞는지 아닌지 확신을 가지지 못한 채로 진행했지만 전문가 미팅을 통해 방향을 잡을 수 있었다.
> 팀원과 끊임없는 회의를 가져 서로 믿고 의지하며 프로젝트를 진행 할 수 있어서 팀 프로젝트의 의의를 알게되었다.
> 결국 최종 오픈 일자에 맞출 수 있어 뿌듯한 프로젝트였다.
